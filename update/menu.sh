...
Isadmin=$(curl -sS https://raw.githubusercontent.com/annelyah23/IP-Register/main/ipmini | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/annelyah23/IP/main/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
echo "IP=$host" > /var/lib/Jsphantom-pro/ipvps.conf
echo ""
...
serverV=$( curl -sS https://raw.githubusercontent.com/annelyah23/update/main/version_up)
if [ "$Isadmin" = "ON" ]; then
