...
Exp=$(curl -sS https://raw.githubusercontent.com/NiLphreakzz/IP-Register/main/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/NiLphreakzSSH/update/main/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/NiLphreakzSSH/update/main/version_up)
...
serverV=$( curl -sS https://raw.githubusercontent.com/NiLphreakzSSH/update/main/version_up)
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1┌─────────────────────────────────────────────────┐$NC"
echo -e "$COLOR1│$NC Version     : SSH XRAYS WEBSOCKET BETA v0.4"
