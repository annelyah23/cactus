...
if [[ -f /etc/Jsphantom/github/api && -f /etc/Jsphantom/github/email && /etc/Jsphantom/github/username ]]; then
   rec="OK"
else
    mkdir /etc/Jsphantom/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/Jsphantom/github/email
echo "$USERNAME1" > /etc/Jsphantom/github/username
echo "$API1" > /etc/Jsphantom/github/api
echo "ON" > /etc/Jsphantom/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1│${NC}    & Nammed : IP-Register "
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}            •   JsPhantom   •    "
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
rm -rf /root/IP-Register
read -p "│  NEW IPVPS : " daftar
echo -e "$COLOR1│${NC}"
echo -e "$COLOR1│${NC}  [INFO] Checking the IPVPS!"
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/IP-Register/main/ipmini | awk '{print $4}' | grep $daftar)
...
git clone https://github.com/${USERGIT}/IP-Register.git &> /dev/null
cd /root/IP-Register/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
...
Reg Date    : $hariini
" 
echo "${TEXT}" >>/root/IP-Register/newuser 
echo "### $client $exp $daftar $isadmin" >>/root/IP-Register/ipmini 
git add .
git commit -m register &> /dev/null
git branch -M main &> /dev/null
git remote add origin https://github.com/${USERGIT}/IP-Register.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/IP-Register.git &> /dev/null
sleep 1
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
function delipvps(){
clear
rm -rf /root/IP-Register &> /dev/null
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/IP-Register.git &> /dev/null
cd /root/IP-Register/ &> /dev/null
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 2-4 | nl -s '. '
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}            •   JsPhantom   •         "
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
name1=$(grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 2 | sed -n "$nombor"p) #name
exp=$(grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 3 | sed -n "$nombor"p) #exp
ivps1=$(grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 4 | sed -n "$nombor"p) #ip
sed -i "s/### $name1 $exp $ivps1//g" /root/IP-Register/ipmini &> /dev/null
...
" 
echo "${TEXTD}" >>/root/IP-Register/delete_log  &> /dev/null
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/IP-Register.git
cd /root/IP-Register/
rm -rf .git
git init
touch ipmini
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/root/IP-Register/ipmini")
...
name1=$(grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p) #name
exp=$(grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p) #exp
ivps1=$(grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p) #ip
...
sed -i "s/### $name1 $exp $ivps1/### $name1 $exp4 $ivps1/g" /root/IP-Register/ipmini
git add .
git commit -m renew
git branch -M main
git remote add origin https://github.com/${USERGIT}/IP-Register.git
git push -f https://${APIGIT}@github.com/${USERGIT}/IP-Register.git
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
grep -E "^### " "/root/IP-Register/ipmini" | cut -d ' ' -f 2 | nl -s '. '
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}            •   JsPhantom   •           "
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
function resetipvps(){
clear
rm -f /etc/Jsphantom/github/email
rm -f /etc/Jsphantom/github/username
rm -f /etc/Jsphantom/github/api
rm -f /etc/Jsphantom/github/gitstat
echo "OFF" > /etc/Jsphantom/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/annelyah23/IP/main/ipmini | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/Jsphantom/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/Jsphantom/github
    touch /etc/Jsphantom/github/gitstat
    echo "OFF" > /etc/Jsphantom/github/gitstat
fi

stst1=$(cat /etc/Jsphantom/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
stst=$(cat /etc/Jsphantom/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
